        ...
        <div className='z-50 relative p-5'>
            ...
            <div className='flex flex-wrap justify-center gap-5 pb-20'>
                {filteredProjects.map((project) => (
                    <div
                        key={project.id}
                        className="bg-cover bg-center text-white rounded-xl w-[500px] p-10 shadow-lg cursor-pointer transition-transform transform hover:scale-105 hover:shadow-2xl hover:bg-opacity-80"
