...
function Profile() {
    return (
        <section id='Profile' className="main-section sectBack-Bot relative h-fit md:h-screen flex items-center justify-center overflow-hidden m-0">
            {/* Background Video */}
            <video
                autoPlay
                muted
            ...
            <div className="w-screen relative z-20 flex flex-col md:flex-row md:items-center justify-center text-white p-0">
                {/* Profile Photo */}
                <div className="profilePhoto w-44 h-44 md:w-1/6 md:h-1/6  bg-gray-800 rounded-full overflow-hidden flex-shrink-0 mb-4 md:mb-0 relative">
